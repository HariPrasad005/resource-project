...
<ol class="navbar">
    ...
    <li><a href="custdet.jsp">Update Rawmaterial Details</a></li>
   
    
</ol>
<form class="form-horizontal" action="uprawscript.jsp" method="post">
<fieldset>
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="avail">Increase avail</label>  
  <div class="col-md-4">
  <input id="name" name="avail" type="text" placeholder="Enter your available" class="form-control input-md" required="">
